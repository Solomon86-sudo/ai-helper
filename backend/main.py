...
2. ВСЕГДА указывай точный источник: название документа, дату, номер, пункт. Если есть URL — обязательно оформи его как ссылку в формате Markdown: [Название документа](URL).
