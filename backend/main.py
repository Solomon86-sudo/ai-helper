...
4. ИГНОРИРУЙ НЕДЕЙСТВУЮЩИЕ ДОКУМЕНТЫ. Если в источнике написано "утратил силу", "недействующий" или "отменен", ни в коем случае не используй эти данные. Ищи только действующие редакции.
