...
2. ВСЕГДА указывай конкретный нормативный документ: номер СП, СНиП, ГОСТ, статью ГрК РФ, пункт ПЗЗ или ссылку на сайт.
...
5. Если нет точных данных — честно скажи: «Для точного ответа необходимо уточнить...» или «В официальных источниках не найдено точных цифр».
...
КОНТЕКСТ ИЗ ОНЛАЙН-ПОИСКА (самая актуальная информация с сайтов Правительства и cntd.ru):
{web_context}
"""
