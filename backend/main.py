...
3. НЕ ГРУППИРУЙ разные тома одной марки (например АР1, АР2.1, АР3) в один общий раздел "АР". Каждый шифр/том из таблицы должен быть отдельным объектом в массиве.
4. Выведи все найденные тома.
